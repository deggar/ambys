...
export default async function ParseStudy(e) {
  ...
  return new Promise((resolve, reject) => {
    ...
    reader.onloadend = function (event) {
      ...
      mammoth
        ...
        .then(function (resultObject) {
          ...
          async function r() {
            const text = await parseFileIntoStudy(resultObject.value);
            // resolve(text);
            return text;
          }
          return r();
    ...
    async function parseFileIntoStudy(text) {
      try {
        // console.log(text);
